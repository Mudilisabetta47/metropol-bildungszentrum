  ...
  return (
    <section className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden">
      ...
      <div 
        ...
        style={{
          background: "linear-gradient(135deg, hsl(213 55% 15%) 0%, hsl(213 45% 22%) 50%, hsl(213 40% 28%) 100%)"
        }}
      />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-primary-foreground">
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6 animate-fade-up animation-delay-100">
              Ihre Karriere im
              <span className="block text-accent">Transportwesen</span>
              beginnt hier
            </h1>
            
            <p className="text-lg sm:text-xl text-primary-foreground/80 leading-relaxed mb-8 max-w-xl animate-fade-up animation-delay-200">
            ...
            <div className="grid grid-cols-3 gap-6 animate-fade-up animation-delay-400">
              {stats.map((stat) => (
                <div key={stat.label} className="text-center sm:text-left">
                  <stat.icon className="h-6 w-6 text-accent mb-2 mx-auto sm:mx-0" />
          ...
          <div className="relative hidden lg:block animate-fade-up animation-delay-200">
            ...
            {/* Floating cards */}
            <div className="absolute -bottom-6 -left-6 bg-card text-card-foreground rounded-xl p-4 shadow-xl animate-scale-in animation-delay-400">
            ...
            <div className="absolute -top-6 -right-6 bg-accent text-accent-foreground rounded-xl p-4 shadow-xl animate-scale-in animation-delay-300">
              <p className="text-sm font-medium opacity-90 mb-1">Förderung möglich</p>
