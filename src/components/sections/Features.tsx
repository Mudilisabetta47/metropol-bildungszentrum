...
function GoogleReviewBadge() {
  ...
  return (
    <a 
      ...
      className="flex items-center gap-4 px-6 py-4 bg-card rounded-xl border border-border hover:border-primary/30 transition-colors group"
    >
      {/* Google Logo */}
      ...
      <div className="flex-1">
        ...
        <p className="text-sm text-muted-foreground">
          {reviewCount} Bewertungen auf Google
        </p>
      </div>
